<div class="project-show-sidebar">
    ...
    <div class="project-show-actions">
        <ul>
            ...
            <li>
                <a href="?controller=category&amp;action=index&amp;project_id=<?= $project['id'] ?>"><?= t('Manage categories') ?></a>
            </li>
            <li>
                <a href="?controller=project&amp;action=users&amp;project_id=<?= $project['id'] ?>"><?= t('Users access') ?></a>
            </li>
            <li>
